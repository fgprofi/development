        ...
        <div class="main__header header-main">
            <div class="containered">
                <div class="header-main__content">
                    ...
                    <!--                    </div>-->
                    <h1 class="header-main__title"><span class="header-main__title-capital" style="color: #111111;"><b>Финансовая грамотность</b></span><span
                                style="color: #111111;"><b> </b></span><br>
        ...
        <div class="content">
            <div class="containered">
                <div class="nav__list">
                    ...
                    <a class="nav__item item-nav"
                       href="/about/kontseptsiya/">
