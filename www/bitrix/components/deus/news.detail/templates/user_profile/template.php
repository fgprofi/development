            ...
            <div class="containered">
                ...
                <div class="account">
                    <div class="account__info">
                        ...
                        <span class="user_mesage">
                            <p class="user_mesage_title">Уважаемый участник Профессионального сообщества!</p>
                            <p class="user_mesage_text">Портал, на которым Вы находитесь, является электронный площадкой для взаимодействия участников Профессионального сообщества, обмена информацией, участия в жизни сообщества. В настоящее время портал активно развивается. На нем будут появляться новые сервисы, в т.ч. по предложениям участников сообщества. Вы также можете сообщить нам свои пожелания, воспользовавшись сервисом «Написать разработчику». </p>
                        </span>
                        <br>
                        <br>
                        <br>
                        ...
                        if (($arResult["FIELDS"]['ACTIVE'] == "Y" && $arResult["PROPERTIES"]["USER_ID"]["VALUE"] == $USER->GetID()) || isAdministrator()): ?>
                            <?if($arResult["PROPERTIES"]["USER_ID"]["VALUE"]){
                                $id = base64_encode($arResult["PROPERTIES"]["USER_ID"]["VALUE"]);
                            }else{
                                $id = base64_encode($arResult["ID"]);
                            }?>
                            <a class="account__btn btn" href="/personal/edit/?id=<?=$id?>">Редактировать профиль</a>
	                    <? endif; ?>
                        ...
                        <? endif; ?>
                        <?if ( $arParams["IBLOCK_ID"] == 7 ):?>
                            <a class="link link-button link-button--disabled" href="/personal/legal_faces/">Мои юр. лица</a>
                        <? endif; ?>
                                    ...
                                    <div class="account__tab-text">
                                        <?foreach($tab["PROPS"] as $propName => $prop):?>
                                            <div class="account__tab-item">
                                                <?if($arParams["PROPS_TITLE"][$propName]):?>
                                                    <div class="account__tab-item-name"><?=$arParams["PROPS_TITLE"][$propName]?></div>
                                                <?else:?>
