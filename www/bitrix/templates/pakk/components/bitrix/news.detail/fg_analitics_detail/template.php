...
$detail_pic = CFile::GetPath($arResult['DETAIL_PICTURE']['ID']);
        ...
        <div class="containered">
            <div class="header-main__content">
                <div class="header-main__block-button">
                    <a class="header-main__button" href="/analitics/">назад</a>
                </div>
    ...
    <div class="content">
        <div class="containered">
            ...
            <div class="main-content">
                ...
                <a class="link link-button link-button_orange" href="/analitics/">назад</a>
            </div>
        </div>
    </div>
</main>