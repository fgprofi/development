        ...
        <div class="containered">
            <div class="header-main__content">
                <div class="header-main__block-button">
                    <a class="header-main__button" href="/my-subscribe/">назад</a>
                </div>
        ...
        <div class="containered">
            ...
            <div class="main-content">
                <div class="detail-news">
                    <?if(in_array($USER->GetID(), $arResult["DISPLAY_PROPERTIES"]["USERS"]["VALUE"])):?>
                ...
                <a class="link link-button link-button_orange" href="/my-subscribe/">назад</a>
            </div>
        </div>
    </div>
</main>