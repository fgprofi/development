    ...
    <div class="main__header header-main">
        <div class="containered">
            <div class="header-main__content">
                ...
                <h1 class="header-main__title">Обзорно-реферативные электронные материалы</h1>
            </div>
        </div>
    </div>
                    ...
                    <div class="news__item item-news">
                        <div class="item-news__top">
                            ...
                            <div class="item-news__right">
                                <p class="item-news__title"><a href="/referal/<?=$arItem['CODE']?>/"><?=$arItem['NAME']?></a></p>
                                <p class="item-news__date"><?=$date?></p>
                            </div>
                        </div>
                        <div class="item-news__bottom">
                            <p class="item-news__desc"><?=$arItem['PREVIEW_TEXT']?><a class="item-news__read-more" href="/referal/<?=$arItem['CODE']?>/">Читать далее »</a>
                            </p>
                        </div>
                    </div>
	                <?endforeach;?>
