...
<div class="login">
    <div class="sign_in">
        ...
        <div class="sign_in_new">
            Новый пользователь?<a href="/freg/">Создать учетную запись</a>
        </div>
        ...
        <div class="bx-system-auth-form">
            ...
            <form name="system_auth_form<?= $arResult["RND"] ?>" method="post" target="_top" action="<?= $arResult["AUTH_URL"] ?>">
                ...
                <a class="form_forgot" href="/auth/restore_password/">Я забыл пароль</a>
            </form>
            <? endif ?>
        </div>
    </div>
    <a class="login_text" href="/about/faq">Как зарегистрироваться на портале?</a>
</div>