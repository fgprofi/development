...
<footer class="footer">
    ...
    <div class="containered footer__containered">
        ...
        <div class="footer__email email">
            ...
            <a href="mailto:cons@fgprofi.ru">cons@fgprofi.ru</a>
    ...
    <div id="logout-popup">
        <div class="logout-popup-text">
            ...
            <a class="logout-popup-btn" href="<? echo $APPLICATION->GetCurPageParam(" logout=yes", array("login", "logout" , "register" , "forgot_password" , "change_password" )); ?>">
                ...
                <form class="modal__form form-modal" action="">
                    ...
                    <div class="form-modal__fields">
                        <div class="form-modal__row required">
                            <input class="form-modal__input" type="text" name="name" data-default-value="<?= $fullName ?>" placeholder="ФИО" value="<?= $fullName ?>">
                        </div>
                        <div class="form-modal__row">
                            <input class="form-modal__input phone" type="tel" name="phone" placeholder="+7 (__) ___-__-__">
                        </div>
                        <div class="form-modal__row">
                            <input class="form-modal__input" type="email" name="email" data-default-value="<?= $email ?>" placeholder="Email" value="<?= $email ?>">
                        </div>
                        <div class="form-modal__row">
                            <textarea class="form-modal__input form-modal__input_textarea" type="text" name="message" placeholder="Введите сообщение..."></textarea>
                        </div>
                        <!--                        <div class="form-modal__row">-->
