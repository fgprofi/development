            ...
            <div class="sign_in">
                <div class="form_title_reg">
                    ...
                    <div class="help">?
                        <div class="help-description" id="form_title_reg_description">
                            ...
                            <p>Прежде чем зарегистрировать юридическое лицо, убедитесь, что уже имеется регистрация физического лица, который будет представителем юридического лица. Его ID необходимо будет указать в соответствующем поле. Также понадобится указать ОГРН организации, название и организационно-правовую форму. На электронную почту представителя юридического лица придет письмо, перейдя по ссылке из которого, Вы активируете профиль юридического лица и сможете продолжить работу в личном кабинете.</p>
                ...
                <form method="post" action="<?= POST_FORM_ACTION_URI ?>" name="regform" enctype="multipart/form-data" autocomplete="off">
                    <div class="layout-mobile">
						...
						<input size="30" type="text" style="display: none;" name="REGISTER[LOGIN]" value="" />
                        ...
                        <div class="form__privacy-policy">
                            <div class="checkbox required form_input">
                                <input id="privacy-policy" type="checkbox" name="PRIVATE_POLICY"><label for="privacy-policy">
