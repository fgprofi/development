        ...
        <div class="cabinet-user flex">
            <div>
                ...
                <div class="cabinet-user__text">
                    ...
                    <span><?= mb_strtolower($arResult["IB_INFO"]["NAME"]); ?></span>
                </div>
            </div>
...
<!--                                                --><?//if($prop_name != 'PROPERTY_REPRESENTATIVE_OF_LEGAL_FACES'){?>
                                                    <div class="select input_box form_input">
                                                        <select <? if ($arProp['IS_REQUIRED'] == "Y" || $arProp["CODE"] == "KIND_OF_ACTIVITY")
                                                            echo ' required ' ?>
                                                                name="<?= $arProp["CODE"] ?><?=$ml?>" class="jsFilterSelect<?=$noCheckGroup?>"
...
<!--                                                --><?//}?>
                                    ...
                                    <div class="input_box checkbox">
                                        ...
                                        if ($prop_name == 'PROPERTY_PERSONAL_DATA') {
                                            ...
                                            if ($arProp["VALUE"] != "") {
                                                ...
                                                ?><input placeholder="Введите сообщение, в котором Вы хотите рассказать другим участникам Сообщества о себе или о своей деятельности" <? if ($arProp['IS_REQUIRED'] == "Y")
                                                    echo ' required ' ?>
                                                type="checkbox"<?= $check ?> value="<?= $enum_fields["ID"]; ?>"
                                                name="<?= $prop_name ?>" id="<?= $prop_name ?>" >
                                            <label for="<?= $prop_name ?>">
                                                <?= $arProp["NAME"] ?><? if ($arProp['IS_REQUIRED'] == "Y")
                                                    echo '<sup>*</sup>' ?>
                                                </label><?
                                            }
                                        } else {
                                ...
                                <? endif; ?>
                                <? if ($arProp["ID"] && $arProp["ID"] != 21 && $arProp["ID"] != 23): ?>
                                    <?
                                    $disabled_check = "";
                                    ...
                                    <div class="input_box checkbox<?=$disabled_check?>">
                                        ...
                                        <label for="VIEW_<?= $prop_name ?>">
                                            Показать <?= $arProp["NAME"] ?> (Информация будет видна всем участникам Сообщества)
                                        </label>
                                    </div>
                                <? endif; ?>
                            <? endforeach; ?>
