                ...
                <form name="system_auth_form<?= $arResult["RND"] ?>" method="post" target="_top"
                    ...
                    <div class="layout-mobile">
                        <div class="form_input email required error">
                            <div>Логин</div>
                            <input autocomplete="off" placeholder="login" onfocus="this.removeAttribute('readonly');" readonly 
                        ...
                        <div class="form_input phone required">
                            <div>Пароль</div>
                            <input name="USER_PASSWORD" maxlength="255" size="17" autocomplete="off" onfocus="this.removeAttribute('readonly');" readonly 
                                   placeholder="Пароль"
                                   type="password">
                        </div>
                    </div>
