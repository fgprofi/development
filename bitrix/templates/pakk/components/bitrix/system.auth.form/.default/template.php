    ...
    <div class="sign_in">
        ...
        <div class="sign_in_option flex layout-mobile">
            <div class="sign_in_option-item flex">
                <div class="sign_in_button<?if($_GET["face"] == "type_f" || !isset($_GET["face"])){echo " active";}?>">
            ...
            <div class="sign_in_option-item sign_in_option-item_entity flex">
                <div class="sign_in_button<?if($_GET["face"] == "type_u"){echo " active";}?>">
                    <div class="active"></div>
                </div>
                <div class="sign_in_text">
                    Юридическое лицо
                    ...
                    <div class="layout-mobile">
                        <?if ($_GET["face"] == "type_f" || !isset($_GET["face"])):?>
                            <div class="form_input email required error">
                                <input autocomplete="off" placeholder="E-mail" onfocus="this.removeAttribute('readonly');" readonly 
                                       type="text" name="USER_LOGIN" maxlength="50" value="" size="17">
                            </div>
                        <?else:?>
                            <div class="form_input email required error">
                                <input autocomplete="off" placeholder="ОГРН" data-min="13" class="maskogrn" onfocus="this.removeAttribute('readonly');" readonly 
                                       type="text" name="USER_LOGIN" maxlength="50" value="" size="17">
                            </div>
                        <?endif;?>
                        <script>
                        ...
                        <div class="form_input phone required">
                            <input name="USER_PASSWORD" minlength="6" maxlength="255" size="17" autocomplete="off" onfocus="this.removeAttribute('readonly');" readonly 
