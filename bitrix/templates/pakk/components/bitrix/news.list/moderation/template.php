                ...
                <div class="profile-moderation__list">
                    ...
                    <div class="profile-filter profile__item">
                        ...
                        <div class="profile-filter__info">
                            <p class="profile-filter__name"><?= mb_strtoupper($props['SURNAME']['VALUE']).' '.mb_strtoupper($props['FIRST_NAME']['VALUE']).' '.mb_strtoupper($props['MIDDLENAME']['VALUE']) ?></p>
                            <p class="profile-filter__career"><?=$props['POSITION']['VALUE']?></p>
