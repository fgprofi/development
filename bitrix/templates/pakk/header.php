...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Roboto:400,500,700&amp;display=swap&amp;subset=cyrillic"
          rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=EB+Garamond:400,500,600,700&amp;display=swap&amp;subset=cyrillic"
          rel="stylesheet">
    ...
    <noscript>
        <div><img src="https://mc.yandex.ru/watch/61863655" style="position:absolute; left:-9999px;" alt=""/></div>
                    ...
                    <div class="modern-version">
                        <div class="containered">
                            <div class="modern-version__attention">
                                <img src="/bitrix/templates/pakk/img/popup-download_version/warning.png" alt="Внимание!"
                                     class="modern-version__attention-img">
                            ...
                            <div class="modern-version__browser">
                                <img class="modern-version__browser-img"
                                     src="/bitrix/templates/pakk/img/popup-download_version/chrome.png">
                                <a href="https://www.google.ru/chrome/" class="modern-version__link">Скачать</a>
                            </div>
                            <div class="modern-version__browser">
                                <img class="modern-version__browser-img"
                                     src="/bitrix/templates/pakk/img/popup-download_version/ie.png">
                                <a href="https://www.microsoft.com/en-us/edge" class="modern-version__link">Скачать</a>
                            </div>
                            <div class="modern-version__browser">
                                <img class="modern-version__browser-img"
                                     src="/bitrix/templates/pakk/img/popup-download_version/opera.png">
                            ...
                            <? else : ?>
                                ...
                                if (CModule::IncludeModule("iblock")) {
                                    ...
                                    <div class="header-hidden-phone"
                                         style="display: none"><?= $arUserFields["PROPS"]['PHONE']['VALUE']; ?></div>
                                    <? endif; ?>
                                    ...
                                    <div class="header-login__drop drop-login <?= $statusClass ?>">
                                        <div class="drop-login__info">
                                            <div class="sign_in_new">
                                                <p class="drop-login__name <?= $loader ?>"><a
                                                            href="/personal/"><?= $fullName ?></a></p>
                                            </div>
